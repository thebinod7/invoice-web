...
export default function MagicLoginForm() {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 max-w-lg mx-auto">
            <h3 className="text-2xl font-semibold text-gray-900 mb-2">Want to save invoices?</h3>
            {/* Sub-text */}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-muted-foreground text-xs px-2">
                    Creating an account is only required to access these features. You can continue
                    without signing up if you prefer. {''}
