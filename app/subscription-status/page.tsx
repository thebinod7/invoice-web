                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-emerald-700 leading-relaxed">
                                    ...
                                    premium features and benefits. Thank you for your support!
                                </p>
                            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-red-700 leading-relaxed">
                                Your subscription payment could not be completed. This might be due
                                to insufficient funds, an expired card, or a temporary issue with
                                your payment provider. Your account remains active with free
                                features only.
                            </p>
                        </div>
                        ...
                        <div>
                            <h3 className="font-semibold text-red-950 mb-3">What you can do:</h3>
